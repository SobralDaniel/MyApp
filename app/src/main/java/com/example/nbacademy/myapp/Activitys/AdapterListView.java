...
import com.example.nbacademy.myapp.Activitys.Activitie;
...
public class AdapterListView extends BaseAdapter {
    ...
    public AdapterListView(List<Activitie> activitiesList, Activity act) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (activitiesList.get(position).getType().equals("T")) {
            ...
            View view = act.getLayoutInflater()
                    .inflate(R.layout.list_activitie2, parent, false);
            Activitie act = activitiesList.get(position);
